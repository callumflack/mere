      ...
      .Container.Container--xl
        .Card-block.p-mo-a0
          .c-block-brand
            ...
            .FlexGrid
              .w-sm-1x2
                p MERE infuses the natural power of rich and unparalleled botanical bio-actives from the furthest reaches of Australia’s untouched landscape. A potency and natural phenomena that sets the base for everything we do.
              .w-sm-1x2
                .AccentParagraph--max-sm
          ...
          .FlexGrid
            ...
            .w-sm-7x12
              .Card-block.p-t0.p-l0
                .Container.Container--sm.m-sm-l0.p-sm-l0
                  ...
                  p.m-sm-l5 All other packaging is assembled from resources that are amongst the worlds most recycled materials. We believe we should be as active for the environment as we are for the skin.
