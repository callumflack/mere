<template lang="pug">
  .u-relative
    ...
    .b-py2
      .Container
        h3.Heading.fw-medium.u-textCenter.m-b3 product.productType
      ...
      .FlexGrid.mo-FlexGrid--block
        ...
        .w-5x6.w-sm-1x3.m-mo-xA.p-mo-b5
          .Tabs
            ...
            label(for="tab-one") #[img(src="/images/products-super-natural-dermal-serum-vaccine-bottle.png")]
            ...
            label(for="tab-two") #[img(src="/images/products-pack-1.png")]
...
/* import shop from "~/apollo/queries/product"; */
